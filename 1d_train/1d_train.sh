...
#SBATCH --output=%A_%a.out   # Standard output file
#SBATCH --error=%A_%a.err     # Standard error file
...
python 1d.py --problem "burgers" --var ${SLURM_ARRAY_TASK_ID} --struct 1 --sensor 101 --batch_size 8000
