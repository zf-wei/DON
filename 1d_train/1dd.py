...
for epoch in range(epochs):
    ...
    for input1_batch, input2_batch, target_batch in train_loader:
        ...
        # print('This is the shape of the input1_batch, input2_batch, and target_batch')
        # print(input1_batch.shape, input2_batch.shape, target_batch.shape)
        optimizer.zero_grad()
        ...
        if False and loss.item()<loss_best:
            loss_best = loss.item()
            best_epoch = epoch
            model_best = model.state_dict().copy()
